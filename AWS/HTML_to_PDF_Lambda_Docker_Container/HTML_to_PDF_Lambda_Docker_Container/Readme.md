...
WORKDIR /src
COPY ["HTML_to_PDF_Lambda_Docker_Container.csproj", "HTML_to_PDF_Lambda_Docker_Container/"]
RUN dotnet restore "HTML_to_PDF_Lambda_Docker_Container/HTML_to_PDF_Lambda_Docker_Container.csproj"

WORKDIR "/src/HTML_to_PDF_Lambda_Docker_Container"
COPY . .
RUN dotnet build "HTML_to_PDF_Lambda_Docker_Container.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "HTML_to_PDF_Lambda_Docker_Container.csproj" \
...
Execute unit tests
```
cd "HTML_to_PDF_Lambda_Docker_Container/test/HTML_to_PDF_Lambda_Docker_Container.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "HTML_to_PDF_Lambda_Docker_Container/src/HTML_to_PDF_Lambda_Docker_Container"
